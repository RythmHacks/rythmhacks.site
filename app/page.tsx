...
const sponsors = [
  ...
  },
  {
    ...
    bgColor: "bg-gradient-to-br from-green-300 to-emerald-500",
    padding: "p-6",
  },
  {
    ...
    bgColor: "bg-gradient-to-br from-red-300 to-rose-600",
    padding: "p-4",
  },
  {
    name: "athena ai",
  ...
  return (
    <div className="w-full">
      ...
      <button
        ...
        className="w-full p-6 rounded-2xl bg-gradient-to-br from-gray-800 to-gray-900 text-white text-left shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] relative group border border-gray-700 hover:border-blue-500 cursor-pointer"
      >
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center p-4 relative overflow-hidden">
      ...
      {/* Background blobs */}
      <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-pink-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob pointer-events-none"></div>
      <div className="absolute top-0 right-0 w-96 h-96 bg-blue-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000 pointer-events-none"></div>
      ...
      {/* FAQ Section */}
      <div id="FAQ" className="self-start py-5 px-10 pb-10 scroll-mt-24">
        <div className="flex items-center">
          <svg
            width="43"
            height="39"
          ...
          <div className="text-center">
            ...
            <div className="border-t border-gray-800 pt-6">
              <p className="text-gray-400 text-sm">
                © 2025 RythmHacks. Made with ❤️ by the RythmHacks team.
              </p>
            </div>
          </div>
        </div>
